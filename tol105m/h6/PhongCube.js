...
var matrixLoc, projectionMatrixLoc;
...
function render() {
    ...
    ctm = mult( mv, translate( -0.4, 0.0, -0.3 ) );
    ctm = mult( ctm, scalem( 0.07, 0.5, 0.07 ) );
    ...
    // Then the table top
    ctm = mult( mv, translate( 0.0, 0.325, 0.0 ) );
    ctm = mult( ctm, scalem( 0.9, 0.2, 0.7 ) );
    gl.uniformMatrix4fv(matrixLoc, false, flatten(ctm));
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices );
