...
window.onload = function init() {
    ...
    gl.uniform1f( gl.getUniformLocation(program, "transThreshold"), transThreshold );
...
function render() {
    ...
    let scale_v = Math.abs(Math.cos(scaler)) + 0.05;
    modelViewMatrix = mult( modelViewMatrix, scalem(scale_v, scale_v, scale_v));
