     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 83:	// s - snýr neðri armi
                ...
                break;
            case 81:	// q - snýr miðju armi
			    theta[2] = Math.min(170, theta[2]+5);
                break;
            case 87:	// w - snýr miðju armi
			    theta[2] = Math.max(-170, theta[2]-5);
                break;
            case 69:    // e - snýr efsta armi
                theta[3] = Math.min(170, theta[3]+5);
                break;
            case 82:    // r - snýr efsta armi
...
function middleArm() {
    var s = scalem(MIDDLE_ARM_WIDTH, MIDDLE_ARM_HEIGHT, MIDDLE_ARM_WIDTH);
...
var render = function() {
    ...
    modelViewMatrix  = mult(modelViewMatrix, rotateZ( theta[MiddleArm] ) );
    middleArm();
